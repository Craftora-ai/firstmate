...
matching strongest profile sets are accepted^{"rules":[{"when":"depth","strongest_reasoning":true,"use":[{"harness":"claude"},{"harness":"codex"}]},{"when":"design","confidence_floor":0.3,"strongest_reasoning":true,"use":[{"harness":"codex"},{"harness":"claude"}]}]}^empty^
different strongest profile sets are flagged^{"rules":[{"when":"depth","strongest_reasoning":true,"use":{"harness":"claude"}},{"when":"design","confidence_floor":0.3,"strongest_reasoning":true,"use":{"harness":"codex"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - every strongest_reasoning rule must use the same profile set
...
large confidence floor is flagged^{"rules":[{"when":"depth","confidence_floor":1.1,"use":{"harness":"claude"}}]}^exact^CREW_DISPATCH: invalid config/crew-dispatch.json - rule confidence_floor must be a number 0..1
